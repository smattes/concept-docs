...
The look of the variables is similar to *bash* but many of the "bash-isms" do not apply. To use a variable you can `${VARIABLE_NAME}`. The above example of creating a VPC would be more useful with the following templating:
```
